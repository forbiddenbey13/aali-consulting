    ...
    <div className="font-sans text-gray-800 bg-white min-h-screen">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-5xl font-bold mb-6 text-gray-900 leading-tight">Find Your Path<br />to Success in Canada</h2>
          ...
          <div className="grid grid-cols-2 gap-8">
            {[
              ...
              <div key={i} className="flex flex-col items-center bg-[#f5faff] rounded-2xl border border-gray-200 p-6 shadow-sm">
                <img src={img.src} alt={img.label} className="w-44 h-44 object-contain mb-4" />
                <div className="font-bold text-center text-lg text-[#1e293b]">{img.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Curriculum Section */}
      <section className="py-20 px-4 bg-white">
        <h2 className="text-4xl font-bold text-center mb-2">Pick Your Path (Curriculum)</h2>
        <p className="text-center mb-10 text-gray-600 text-lg">Four Clear Paths to Work & Business Success</p>
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="flex bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
            <div className="flex items-center justify-center w-40 min-w-[120px] bg-[#f5faff] text-blue-600 text-3xl font-bold h-full p-8">Path A</div>
            <div className="flex-1 p-8">
              <div className="font-semibold mb-1 text-lg">Employment (Get Hired Fast)</div>
          ...
          <div className="flex bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
            <div className="flex items-center justify-center w-40 min-w-[120px] bg-[#f5faff] text-blue-600 text-3xl font-bold h-full p-8">Path B</div>
            <div className="flex-1 p-8">
              <div className="font-semibold mb-1 text-lg">Self-Employment & Freelancing</div>
              <ul className="list-disc pl-5 text-gray-700 text-base">
          ...
          <div className="flex bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
            <div className="flex items-center justify-center w-40 min-w-[120px] bg-[#f5faff] text-blue-600 text-3xl font-bold h-full p-8">Path C</div>
            <div className="flex-1 p-8">
              <div className="font-semibold mb-1 text-lg">Small Business Startup (Company Launch)</div>
              <ul className="list-disc pl-5 text-gray-700 text-base">
          ...
          <div className="flex bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
            <div className="flex items-center justify-center w-40 min-w-[120px] bg-[#f5faff] text-blue-600 text-3xl font-bold h-full p-8">Path D</div>
            <div className="flex-1 p-8">
              <div className="font-semibold mb-1 text-lg">E-Commerce Launch</div>
              <ul className="list-disc pl-5 text-gray-700 text-base">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          ...
          />
          <div>
            <h3 className="text-2xl font-bold mb-4 text-gray-900">Practical Toolkits You’ll Use from Day One</h3>
