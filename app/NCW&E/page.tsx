    ...
    <div className="font-sans text-gray-800 dark:text-gray-300 bg-white dark:bg-gray-900 min-h-screen transition-colors duration-300">
      ...
      <section className="py-20 px-4 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-5xl font-bold mb-6 text-gray-900 dark:text-white leading-tight">Find Your Path<br />to Success in Canada</h2>
          ...
          <div className="grid grid-cols-2 gap-8">
            {[
              ...
              <div key={i} className="flex flex-col items-center bg-[#f5faff] dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                <img src={img.src} alt={img.label} className="w-44 h-44 object-contain mb-4" />
                <div className="font-bold text-center text-lg text-[#1e293b] dark:text-gray-100">{img.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-gray-900 dark:bg-gray-900">
        <h2 className="text-4xl font-bold text-center mb-2 text-white">Pick Your Path (Curriculum)</h2>
        <p className="text-center mb-10 text-gray-400 text-lg">Four Clear Paths to Work & Business Success</p>
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="flex bg-gray-900 border border-gray-700 rounded-2xl shadow-sm overflow-hidden">
            <div className="flex items-center justify-center w-40 min-w-[120px] bg-gray-800 text-blue-500 text-3xl font-bold h-full p-8">Path A</div>
            <div className="flex-1 p-8">
              <div className="font-semibold mb-1 text-lg text-white">Employment (Get Hired Fast)</div>
          ...
          <div className="flex bg-gray-900 border border-gray-700 rounded-2xl shadow-sm overflow-hidden">
            <div className="flex items-center justify-center w-40 min-w-[120px] bg-gray-800 text-blue-500 text-3xl font-bold h-full p-8">Path B</div>
            <div className="flex-1 p-8">
              <div className="font-semibold mb-1 text-lg text-white">Self-Employment & Freelancing</div>
              <ul className="list-disc pl-5 text-gray-300 text-base">
          ...
          <div className="flex bg-gray-900 border border-gray-700 rounded-2xl shadow-sm overflow-hidden">
            <div className="flex items-center justify-center w-40 min-w-[120px] bg-gray-800 text-blue-500 text-3xl font-bold h-full p-8">Path C</div>
            <div className="flex-1 p-8">
              <div className="font-semibold mb-1 text-lg text-white">Small Business Startup (Company Launch)</div>
              <ul className="list-disc pl-5 text-gray-300 text-base">
          ...
          <div className="flex bg-gray-900 border border-gray-700 rounded-2xl shadow-sm overflow-hidden">
            <div className="flex items-center justify-center w-40 min-w-[120px] bg-gray-800 text-blue-500 text-3xl font-bold h-full p-8">Path D</div>
            <div className="flex-1 p-8">
              <div className="font-semibold mb-1 text-lg text-white">E-Commerce Launch</div>
              <ul className="list-disc pl-5 text-gray-300 text-base">
      ...
      <section className="py-20 px-4 bg-white dark:bg-gray-900 treansition-colors duration-300">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          ...
          />
          <div>
            <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Practical Toolkits You’ll Use from Day One</h3>
      ...
      <section className="py-20 px-4 bg-white dark:bg-gray-900">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">You’ll See Progress — Not Just Lessons</h3>
            <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-base">
      ...
      {/* Safety Section */}
      <section className="py-20 px-4 bg-white dark:bg-gray-900">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-10 text-gray-900 dark:text-white">We Keep You Safe While You Grow</h2>
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-8 text-center">
            <div className="font-bold mb-2 text-gray-900 dark:text-white">Legal Awareness</div>
            <div className="text-gray-600 dark:text-gray-400 text-sm">Stay within immigration and business permit conditions.</div>
          </div>
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-8 text-center">
            <div className="font-bold mb-2 text-gray-900 dark:text-white">Tax Readiness</div>
            <div className="text-gray-600 dark:text-gray-400 text-sm">Know when and how to register for GST/HST and file accurately.</div>
          </div>
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-8 text-center">
            <div className="font-bold mb-2 text-gray-900 dark:text-white">Ethical Business Practices</div>
            <div className="text-gray-600 dark:text-gray-400 text-sm">Comply with import rules, privacy laws, and fair consumer standards.</div>
          </div>
        </div>
      </section>
